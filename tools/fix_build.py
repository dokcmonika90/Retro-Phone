...
# SMB3's ROM header uses horizontal mirroring; MMC3 register $A000 controls it.
...
# A 60 Hz NES frame is about 29,780 CPU cycles, not instructions. The compact
# interpreter averages roughly three cycles per instruction, so ~10,000 steps is
# the correct scale for this core. Clear VBlank before each new frame.
